...
simulation_rf_fit %>% 
    filter(rf == 0) %>%
    count(name, model) %>% mutate(n2 = n/160) %>% print.data.frame()
# A tibble: 7 x 2
#   model       n
#   <chr>   <int>
# 1 GTR20      44
...
#    name   model  n      n2
# 1  1IBS      m4  1 0.00625
# 2    HA   GTR20  9 0.05625
# 3    HA      m1  2 0.01250
# 4    HA      m2  4 0.02500
# 5    HA      m3  2 0.01250
# 6    HA      m4  1 0.00625
# 7    HA      m5  1 0.00625
# 8    HA poisson  1 0.00625
# 9   HIV   GTR20 27 0.16875
# 10  HIV      m1 14 0.08750
# 11  HIV      m2 13 0.08125
# 12  HIV      m3  9 0.05625
# 13  HIV      m4 10 0.06250
# 14  HIV      m5  1 0.00625
# 15  HIV poisson 13 0.08125
# 16   NP   GTR20  8 0.05000
# 17   NP      m1  5 0.03125
# 18   NP      m2  3 0.01875
# 19   NP      m3  2 0.01250
# 20   NP      m4  3 0.01875
# 21   NP poisson  2 0.01250
